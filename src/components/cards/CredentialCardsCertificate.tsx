...
type CredentialCardsCertificateProps = {
  identifier: boolean;
  setIdentifier: Function;
  Data?: Any;
};

export const CredentialCardsCertificate: React.FC<
  CredentialCardsCertificateProps
> = ({identifier, setIdentifier, Data}) => {
  return (
    <View style={ItemCard}>
      ...
      <View>
        {identifier ? <DataCredentialCertificate Data={Data} /> : <View />}
      </View>
    </View>
  );
};

const DataCredentialCertificate = ({Data}) => {
  return (
    <View>
...
export default CredentialCardsCertificate;
